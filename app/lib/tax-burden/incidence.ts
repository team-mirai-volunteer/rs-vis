...
// Japan's wage allocation needs only these totals, independent of OECD metadata.
type WageIncidenceTotals = Pick<IncidenceDataset, 'corporateTaxTotal' | 'wagesAndSalaries'>;
 ...
 */
export function wageIncidenceRate(data: WageIncidenceTotals | null | undefined, share: number): number {
...
export function corporateTaxOnWages(data: WageIncidenceTotals | null | undefined, wages: number, share: number): number {
