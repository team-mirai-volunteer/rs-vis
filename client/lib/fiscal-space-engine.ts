import { TRILLION, assumptionRecords } from '@/app/lib/fiscal-space/assumptions';
import { referenceRecords } from '@/app/lib/fiscal-space/calibration';
...
import { projectResponse } from '@/app/lib/fiscal-space/project-response';
...
import { estimatePolicyLoad, resourceRecords } from '@/app/lib/fiscal-space/resource-estimate';
import { buildDebtPortfolio, debtPortfolioRecords } from '@/app/lib/fiscal-space/debt-portfolio';
import { capacityCalibrationRecords } from '@/app/lib/fiscal-space/capacity-calibration';
import { povertyScenario, POVERTY_RECORDS } from '@/app/lib/fiscal-space/poverty';
...
export { EXTENDED_HORIZON } from './fiscal-scenario';
...
export function createFiscalEngine() {
  ...
  return (form: FiscalForm) => {
    const { initial, p, horizon, simulationYears, shock, policyConfigs, policies, allocated, mix, totalYen } = prepareFiscalScenario(form);
