...
const LABELS: Record<string, string> = {
  ...
  inflationPersistence: 'インフレの持続率', energyPricePassThrough: '輸入エネルギー費のCPI転嫁係数',
  energyDomesticPricePassThrough: '輸入価格上昇分の国内価格への転嫁率', expenditurePriceIndexation: '既存歳出のCPI連動率',
  capacityPriceSensitivity: '稼働率による価格補正の強さ', capacityPressureStart: '価格補正が始まる稼働率', referenceCapacityRatio: '価格補正の参照最大能力 / 潜在GDP',
  ...
  searchTolerance: '境界探索の分解能', reserveShare: '定率控除（現在は0・ストレス控除に置換）', stresses: '参考上限が耐えるストレス', cpiCeiling: '許容インフレ−0.3pt', energyPrice: '輸入エネルギー+20%',
