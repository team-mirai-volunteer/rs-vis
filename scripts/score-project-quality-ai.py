...
def build_unified_system(anchors, tax, detail_by_pid):
    ...
    return (
        ...
        '【国民便益の原則】この採点は日本の納税者の視点で行う。\n'
        '「国民」とは日本国民・国内居住者・国内事業者・自治体を指す。\n'
        '事業の直接の受益者が国民でない場合（外国人・外国政府・国際機関・海外事業者など）、\n'
        'その事業は「国民にどう戻るか」（国内就職・国内産業への波及・外交上の具体的成果・安全の確保・\n'
        '国富増強＝自給率向上・貿易赤字削減・エネルギー自給・供給途絶リスクの低減など）が\n'
        '具体的に説明・計測されている限りで評価する。「国際貢献」「友好」「知日派」のような抽象語だけでは\n'
        '国民への便益とみなさない。ただし国外主体が受益者であること自体を減点理由にはしない。\n'
        '問うのは「誰が受け取るか」ではなく「日本社会に何が戻るかが示されているか」である。\n'
        '段階1〜4のそれぞれで、この原則をどう適用するかを個別に指示する。\n\n'
        ...
        '国民便益の適用:\n'
        '- 「誰の課題か」の「誰」を最終受益者まで辿る。アウトカムが国民のどんな状態の改善なのかが\n'
        '  概要文またはロジックモデルで特定できるかを見る。\n'
        '- 直接の受益者が国外主体の場合、「国民に何が戻るか」がアウトカムとして書かれているかを確認する。\n'
        '  受益者の状態改善（例: 留学生の学位取得、相手国の制度整備）で止まっていて国民側の便益が\n'
        '  設計されていなければ、経路が国民まで到達していないとみなし 6 を上限とする。\n'
        '- 国民便益が抽象語（国際貢献・友好・プレゼンス向上）でしか書かれていない場合も同様に扱う。\n'
        ...
        '国民便益の適用:\n'
        '- 登録アウトカムが何を測っているかを見る。国民の状態（所得・安全・健康・国内雇用・国内産業の実績など）を\n'
        '  測る指標が実績付きであれば通常どおり評価する。\n'
        '- 直接の受益者が国外主体の事業で、アウトカム指標が受益者側の到達（採用人数・修了者数・相手国の指標）\n'
        '  だけなら、国民便益は未計測である。この場合は登録上アウトカムでも 7 を上限とする。\n'
        '  国民に戻る便益（国内就職者数・国内企業との共同件数・日本への投資額など）が実績付きで\n'
        '  登録されている場合のみ 8 以上に置く。\n'
        '- finding には、国外主体が受益者の事業では「国民便益の実績あり／未計測」のどちらかを含めること。\n'
        ...
        '  ただし認定件数・認定額・交付済み額・採択企業名など最終配分を追える情報が本文や指標に示されていれば、\n'
        '  基金経由であること自体は軽い減点にとどめる。残高だけが大きく配分先を書けない場合に強く減点する。\n'
        ...
        '  金額シェアに応じて減点する。\n'
        '- 国外への流出: 支出先の大半が外国人・外国政府・国際機関・海外事業者である場合、\n'
        '  「直接給付で中抜きなし」だけを理由に高くしない。その金が国民に何を買っているか\n'
        '  （国内就職・国内調達・日本側の権益や成果物）が単価と対応づけて説明できるかを問う。\n'
        '  説明できなければ、単価が示されていても 7 を上限とする。国外主体への支出そのものは減点しない。\n\n'
        '次は減点理由として認めない:\n'
        ...
        '   困る主体が国民か国外主体かを必ず区別する。国外主体が困る場合は、それによって\n'
        '   国民が失うもの（国内の人材供給・輸出機会・安全・外交上の具体的成果・\n'
        '   供給途絶への耐性・自給率・エネルギー自給・貿易収支の改善など国富増強に関わるもの）まで書く。\n'
        '   供給力を買う事業では「輸入依存に戻る」「供給途絶時に国内生産が無い」が国民の失うものになる。\n'
        '   ただし自給率や供給途絶リスクが数値・事実で示されている場合に限り、抽象的な「経済安全保障」だけでは認めない。\n'
        '   国民が失うものを具体的に書けない場合、この事業の「廃止できない度」は国民にとっては低い。\n'
        '   「国際的な信用」「日本のプレゼンス」のような抽象語は国民が失うものとして認めない。\n'
        '1b. 負担の帰属を判定する: この便益を受ける者（またはその所属組織・出身国）が\n'
        '   自ら負担すべき性質のものか。これはコスト比較とは別の問いであり、\n'
        '   「受益者にとっては国費が一番安い」ことを負担帰属の理由にしてはならない。\n'
        '   受益者が国外主体で、国民に戻る便益が示されていない場合は「受益者負担が相当」と判定する。\n'
        '2. 代替経路を洗い出す。次のすべてを検討すること:\n'
        '   a. 民間・市場が担えないか（担えないならなぜ市場が失敗するのか）\n'
        '   b. 自治体・業界団体・受益者自身・相手国政府が負担すべきものではないか（1b の判定を使う）\n'
        ...
        '5. 採点する: 廃止による国民の具体的な不利益が大きく、かつ同等以下のコストの代替経路が無いほど高い。\n'
        '   困る人を特定できない、または同等以下のコストで代替できるなら低い。\n'
        '   機能そのものは不可欠でも、その手段・単価に代替余地があるなら中位にとどめる。\n'
        '   困るのが国外主体のみで、国民が失うものを具体的に書けない場合は 5 を上限とする。\n'
        '   国民が失うものが書けても、1b で「受益者負担が相当」なら 6 を上限とする。\n\n'
        '減点する状況:\n'
        '- 廃止しても誰が困るか具体的に書けない（抽象語でしか答えられない）\n'
        '- 困るのが国外主体だけで、国民に戻る便益が抽象語でしか説明されていない\n'
        '- 受益者がごく限られた集団（規模の大小を問わない）で、なぜその集団に公費を投じるのかが説明されていない\n'
        ...
        '  (1) 廃止したとき困る主体と、失われるもの。主体が国外主体なら、国民が失うものを続けて書く。\n'
        '      国民が失うものを書けないときは「国民便益不明」と書く\n'
        '  (2) 代替経路と、そのコスト判定。'
        '「安い」「同等」「割高」「不明」「代替なし」のいずれかの語を必ず含めること。\n'
        '      1b で受益者負担が相当と判定したら「受益者負担」の語を含めること\n'
        '  (3) 代替を阻む要因（技術／制度／責任・裁量／なし）\n'
        '書き方の例:\n'
        '  審査官が先行技術調査を失う。自動化で安い見込み(18.2万円/件)。制度\n'
        '  ASEAN各国が地域調整を失う→日本企業の域内進出支援が止まる。二国間協力は割高。責任\n'
        '  留学生が奨学金を失う。国民便益不明。出身国・大学の受益者負担が相当、割高。制度\n'
