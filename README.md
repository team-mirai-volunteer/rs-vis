...
| `/sankey-svg` | SVGベース直接支出サンキー図（2024/2025年度・TopNスライダー・予算/支出フィルタ・会計区分フィルタ・府省庁フィルタ複数選択・ノードPin・ミニマップ・検索・支出先なしノード対応・省庁クリック連動フィルタ・検索/フィルタ独立パネル・フィルタ解除ボタン・フォントサイズ設定・ズーム連動ラベル拡大・サイドパネルに会計内訳表示） |
